...
var over9000 = function(number) {return number > 9000};
...
var valueAtKey = function(dictionary, key) {return dictionary[key]};
...
var y = function(gradient, x_coord, y_intercept) {return gradient*x_coord + y_intercept};
...
var countItem = function(array, value) {return array.filter((v) => (v === value)).length;};
