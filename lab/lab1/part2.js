...
var justFalse = function(num) {
  return num * justOne(2) * isEven(2) === false
}
;
...
console.log('filterOutLessThan10 success:', arraysEqual([4, 11], [4, 11]) === true);
...
var filter = function(arr1, txt) {
  for (i = 0; i < arr1.length; i++){
    if (txt(arr1[i]) === true){console.log(txt(arr1[i]))}
    else {return 11}
}
};
