...
var largeStationList = _.filter(data, function(bike){
    return bike[3] > 20;
});
console.log(largeStationList);

var largeStationCount = _.countBy(data, function(bike){
    return bike[3] > 20 ? 'number greater than 20': 'number less than or equal to 20';
});
