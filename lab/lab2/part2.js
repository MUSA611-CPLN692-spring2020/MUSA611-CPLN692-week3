...
var largeStationList = _.filter(data, function(arrofarr) {
  return arrofarr[3] > 20;
});
console.log(largeStationList);

var largeStationCount = _.countBy(data, function(arrofarr) {
  return arrofarr[3] > 20 ? 'large':'small';
});
