...
var sumList = jeffGameList.concat(nathanGameList);
var query2 = _.filter(sumList, function(game){
    return game !== query1;
});
...
var query8 = _.uniq(_.difference(jeffGameList,nathanGameList).concat(_.difference(nathanGameList,jeffGameList)));
