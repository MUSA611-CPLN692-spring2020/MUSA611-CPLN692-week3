...
var query1 = _.find(jeffGameList, function(num) {return true;});
...
// ["monopoly", "sorry", "pandemic", "candyland"]
...
// ["candyland", "catan", "chess", "dice", "monopoly", "pandemic", "sorry"]
...
var query8 = _.union(
  _.difference(jeffGameList, nathanGameList),
  _.difference(nathanGameList, jeffGameList)
);
